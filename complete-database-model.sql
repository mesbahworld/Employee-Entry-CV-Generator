-- Using default object types (all)
-- ===============================
-- DDL Export for Schema: UNORGANIZED
-- Generated: 2025-09-06 01:39:46
-- Object Types: TYPE,SEQUENCE,TABLE,CONSTRAINT,INDEX,TRIGGER,FUNCTION,PROCEDURE,PACKAGE,PACKAGE BODY,VIEW,MATERIALIZED VIEW,SYNONYM,GRANT
-- ===============================

-- ===============================
-- PASS 1: Object Specs and Structure
-- ===============================

-- ===============================
-- TYPE: UNORGANIZED.PG_DOC_TAG
-- ===============================

  CREATE OR REPLACE EDITIONABLE TYPE "UNORGANIZED"."PG_DOC_TAG" AS TABLE OF VARCHAR2(200);
/

/

-- ===============================
-- SEQUENCE: UNORGANIZED.DBTOOLS$EXECUTION_HISTORY_SEQ
-- ===============================

   CREATE SEQUENCE  "UNORGANIZED"."DBTOOLS$EXECUTION_HISTORY_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 61 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
/

-- ERROR: Could not get DDL for SEQUENCE ISEQ$$_79996
-- Error: ORA-31603: object "ISEQ$$_79996" of type SEQUENCE not found in schema "UNORGANIZED"

-- ===============================
-- SEQUENCE: UNORGANIZED.PG1_SEQ_DEPARTMENT_MASTER
-- ===============================

   CREATE SEQUENCE  "UNORGANIZED"."PG1_SEQ_DEPARTMENT_MASTER"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
/

-- ===============================
-- SEQUENCE: UNORGANIZED.PG1_SEQ_DESIGNATION_MASTER
-- ===============================

   CREATE SEQUENCE  "UNORGANIZED"."PG1_SEQ_DESIGNATION_MASTER"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
/

-- ===============================
-- SEQUENCE: UNORGANIZED.PG1_SEQ_EMPLOYEE_EDUCATION
-- ===============================

   CREATE SEQUENCE  "UNORGANIZED"."PG1_SEQ_EMPLOYEE_EDUCATION"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 101 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
/

-- ===============================
-- SEQUENCE: UNORGANIZED.PG1_SEQ_EMPLOYEE_EXPERIENCE
-- ===============================

   CREATE SEQUENCE  "UNORGANIZED"."PG1_SEQ_EMPLOYEE_EXPERIENCE"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 101 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
/

-- ===============================
-- SEQUENCE: UNORGANIZED.PG1_SEQ_EMPLOYEE_MASTER
-- ===============================

   CREATE SEQUENCE  "UNORGANIZED"."PG1_SEQ_EMPLOYEE_MASTER"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
/

-- ===============================
-- SEQUENCE: UNORGANIZED.PG1_SEQ_LOOKUP_VALUES
-- ===============================

   CREATE SEQUENCE  "UNORGANIZED"."PG1_SEQ_LOOKUP_VALUES"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 61 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
/

-- ===============================
-- TABLE: UNORGANIZED.DBTOOLS$EXECUTION_HISTORY
-- ===============================

  CREATE TABLE "UNORGANIZED"."DBTOOLS$EXECUTION_HISTORY" 
   (	"ID" NUMBER NOT NULL ENABLE, 
	...
	"STATEMENT" CLOB, 
	"TIMES" NUMBER, 
	 CONSTRAINT "DBTOOLS$EXECUTION_HISTORY_PK" PRIMARY KEY ("ID") ENABLE
   ) ;
/


-- ===============================
-- TABLE: UNORGANIZED.PG1_DEPARTMENT_MASTER
-- ===============================

  CREATE TABLE "UNORGANIZED"."PG1_DEPARTMENT_MASTER" 
   (	"DEPT_ID" NUMBER, 
	...
	"CREATED_DATE" DATE DEFAULT SYSDATE, 
	 ...
	 UNIQUE ("DEPT_CODE") ENABLE
   ) ;
/


-- ===============================
-- TABLE: UNORGANIZED.PG1_DESIGNATION_MASTER
-- ===============================

  CREATE TABLE "UNORGANIZED"."PG1_DESIGNATION_MASTER" 
   (	"DESIG_ID" NUMBER, 
	"DESIG_CODE" VARCHAR2(20) NOT NULL ENABLE, 
	"DESIG_NAME" VARCHAR2(100) NOT NULL ENABLE, 
	"DEPT_ID" NUMBER, 
	"IS_ACTIVE" CHAR(1) DEFAULT 'Y', 
	"CREATED_DATE" DATE DEFAULT SYSDATE, 
	 CHECK (IS_ACTIVE IN ('Y', 'N')) ENABLE, 
	 PRIMARY KEY ("DESIG_ID") ENABLE, 
	 UNIQUE ("DESIG_CODE") ENABLE
   ) ;
/


-- ===============================
-- TABLE: UNORGANIZED.PG1_EMPLOYEE_EDUCATION
-- ===============================

  CREATE TABLE "UNORGANIZED"."PG1_EMPLOYEE_EDUCATION" 
   (	"EDU_ID" NUMBER, 
	"EMP_ID" NUMBER NOT NULL ENABLE, 
	"DEGREE_TYPE" VARCHAR2(50) NOT NULL ENABLE, 
	"DEGREE_TITLE" VARCHAR2(100) NOT NULL ENABLE, 
	"INSTITUTION_NAME" VARCHAR2(200) NOT NULL ENABLE, 
	"PASSING_YEAR" NUMBER(4,0) NOT NULL ENABLE, 
	"RESULT_TYPE" VARCHAR2(20), 
	"RESULT_VALUE" VARCHAR2(20), 
	"DURATION_YEARS" NUMBER(2,0), 
	...
	"MODIFIED_BY" VARCHAR2(100), 
	 ...
	 CONSTRAINT "PG1_CHK_PASSING_YEAR" CHECK (PASSING_YEAR BETWEEN 1950 AND 2030) ENABLE, 
	 PRIMARY KEY ("EDU_ID") ENABLE
   ) ;
/


-- ===============================
-- TABLE: UNORGANIZED.PG1_EMPLOYEE_EXPERIENCE
-- ===============================

  CREATE TABLE "UNORGANIZED"."PG1_EMPLOYEE_EXPERIENCE" 
   (	"EXP_ID" NUMBER, 
	"EMP_ID" NUMBER NOT NULL ENABLE, 
	...
	"MODIFIED_BY" VARCHAR2(100), 
	 CHECK (IS_CURRENT IN ('Y', 'N')) ENABLE, 
	 CONSTRAINT "PG1_CHK_DATE_LOGIC" CHECK (END_DATE IS NULL OR END_DATE >= START_DATE) ENABLE, 
	 PRIMARY KEY ("EXP_ID") ENABLE
   ) ;
/


-- ===============================
-- TABLE: UNORGANIZED.PG1_EMPLOYEE_MASTER
-- ===============================

  CREATE TABLE "UNORGANIZED"."PG1_EMPLOYEE_MASTER" 
   (	"EMP_ID" NUMBER, 
	"EMP_CODE" VARCHAR2(20) NOT NULL ENABLE, 
	...
	"PHONE" VARCHAR2(20), 
	"MOBILE" VARCHAR2(20), 
	"NID" VARCHAR2(17) NOT NULL ENABLE, 
	"DATE_OF_BIRTH" DATE, 
	"GENDER" VARCHAR2(20), 
	...
	"MODIFIED_BY" VARCHAR2(100), 
	 ...
	 CHECK (IS_ACTIVE IN ('Y', 'N')) ENABLE, 
	 CONSTRAINT "PG1_CHK_EMAIL_FORMAT" CHECK (REGEXP_LIKE(EMAIL, '^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,}$')) ENABLE, 
	 CONSTRAINT "PG1_CHK_NID_FORMAT" CHECK (REGEXP_LIKE(NID, '^[0-9]{10}$|^[0-9]{13}$|^[0-9]{17}$')) ENABLE, 
	 PRIMARY KEY ("EMP_ID") ENABLE, 
	 UNIQUE ("EMP_CODE") ENABLE, 
	 UNIQUE ("EMAIL") ENABLE, 
	 UNIQUE ("NID") ENABLE
   ) ;
/
...
-- ===============================
-- TABLE: UNORGANIZED.PG1_LOOKUP_VALUES
-- ===============================

  CREATE TABLE "UNORGANIZED"."PG1_LOOKUP_VALUES" 
   (	"LOOKUP_ID" NUMBER, 
	"LOOKUP_TYPE" VARCHAR2(50) NOT NULL ENABLE, 
	"LOOKUP_CODE" VARCHAR2(20) NOT NULL ENABLE, 
	"LOOKUP_VALUE" VARCHAR2(100) NOT NULL ENABLE, 
	"DISPLAY_ORDER" NUMBER DEFAULT 0, 
	"IS_ACTIVE" CHAR(1) DEFAULT 'Y', 
	"CREATED_DATE" DATE DEFAULT SYSDATE, 
	 CHECK (IS_ACTIVE IN ('Y', 'N')) ENABLE, 
	 PRIMARY KEY ("LOOKUP_ID") ENABLE, 
	 CONSTRAINT "PG1_UK_LOOKUP_TYPE_CODE" UNIQUE ("LOOKUP_TYPE", "LOOKUP_CODE") ENABLE
   ) ;
/


-- ===============================
-- TABLE: UNORGANIZED.PG_DOCS
-- ===============================

  CREATE TABLE "UNORGANIZED"."PG_DOCS" 
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE, 
	...
	"LINK" VARCHAR2(500), 
	"CODE_FILE" VARCHAR2(500), 
	"LANGUAGE" VARCHAR2(50), 
	"CLASS_NAME" VARCHAR2(100), 
	"TAGS" "UNORGANIZED"."PG_DOC_TAG" , 
	 PRIMARY KEY ("ID") ENABLE
   ) 
 NESTED TABLE "TAGS" STORE AS "PG_DOCS_TAGS"
 RETURN AS VALUE;
/
...
-- ERROR: Could not get DDL for TABLE PG_DOCS_TAGS
-- Error: ORA-31603: object "PG_DOCS_TAGS" of type TABLE not found in schema "UNORGANIZED"

-- ===============================
-- INDEX: UNORGANIZED.DBTOOLS$EXECUTION_HISTORY_PK
-- ===============================

  CREATE UNIQUE INDEX "UNORGANIZED"."DBTOOLS$EXECUTION_HISTORY_PK" ON "UNORGANIZED"."DBTOOLS$EXECUTION_HISTORY" ("ID") 
  ;
/

-- ===============================
-- INDEX: UNORGANIZED.PG1_IDX_DEPT_SEARCH
-- ===============================

  CREATE INDEX "UNORGANIZED"."PG1_IDX_DEPT_SEARCH" ON "UNORGANIZED"."PG1_DEPARTMENT_MASTER" (UPPER("DEPT_NAME"), UPPER("DEPT_CODE")) 
  ;
/

-- ===============================
-- INDEX: UNORGANIZED.PG1_IDX_DESIG_SEARCH
-- ===============================

  CREATE INDEX "UNORGANIZED"."PG1_IDX_DESIG_SEARCH" ON "UNORGANIZED"."PG1_DESIGNATION_MASTER" (UPPER("DESIG_NAME"), UPPER("DESIG_CODE")) 
  ;
/

-- ===============================
-- INDEX: UNORGANIZED.PG1_IDX_EDU_EMP
-- ===============================

  CREATE INDEX "UNORGANIZED"."PG1_IDX_EDU_EMP" ON "UNORGANIZED"."PG1_EMPLOYEE_EDUCATION" ("EMP_ID") 
  ;
/

-- ===============================
-- INDEX: UNORGANIZED.PG1_IDX_EMP_DEPT
-- ===============================

  CREATE INDEX "UNORGANIZED"."PG1_IDX_EMP_DEPT" ON "UNORGANIZED"."PG1_EMPLOYEE_MASTER" ("DEPARTMENT_ID") 
  ;
/

-- ===============================
-- INDEX: UNORGANIZED.PG1_IDX_EMP_DESIG
-- ===============================

  CREATE INDEX "UNORGANIZED"."PG1_IDX_EMP_DESIG" ON "UNORGANIZED"."PG1_EMPLOYEE_MASTER" ("DESIGNATION_ID") 
  ;
/

-- ===============================
-- INDEX: UNORGANIZED.PG1_IDX_EMP_SEARCH
-- ===============================

  CREATE INDEX "UNORGANIZED"."PG1_IDX_EMP_SEARCH" ON "UNORGANIZED"."PG1_EMPLOYEE_MASTER" (UPPER("FIRST_NAME"), UPPER("LAST_NAME"), "EMP_CODE") 
  ;
/

-- ===============================
-- INDEX: UNORGANIZED.PG1_IDX_EXP_EMP
-- ===============================

  CREATE INDEX "UNORGANIZED"."PG1_IDX_EXP_EMP" ON "UNORGANIZED"."PG1_EMPLOYEE_EXPERIENCE" ("EMP_ID") 
  ;
/

-- ===============================
-- INDEX: UNORGANIZED.PG1_IDX_LOOKUP_TYPE
-- ===============================

  CREATE INDEX "UNORGANIZED"."PG1_IDX_LOOKUP_TYPE" ON "UNORGANIZED"."PG1_LOOKUP_VALUES" ("LOOKUP_TYPE", "IS_ACTIVE") 
  ;
/

-- ===============================
-- INDEX: UNORGANIZED.PG1_UK_LOOKUP_TYPE_CODE
-- ===============================

  CREATE UNIQUE INDEX "UNORGANIZED"."PG1_UK_LOOKUP_TYPE_CODE" ON "UNORGANIZED"."PG1_LOOKUP_VALUES" ("LOOKUP_TYPE", "LOOKUP_CODE") 
  ;
/

-- ===============================
-- INDEX: UNORGANIZED.SYS_FK0000079996N00011$
-- ===============================

  CREATE INDEX "UNORGANIZED"."SYS_FK0000079996N00011$" ON "UNORGANIZED"."PG_DOCS_TAGS" ("NESTED_TABLE_ID") 
  ;
/

-- ===============================
-- PACKAGE: UNORGANIZED.PG1_PKG_EMPLOYEE_MGMT
-- ===============================
-- ERROR: Could not get DDL for PACKAGE PG1_PKG_EMPLOYEE_MGMT
-- Error: ORA-06502: PL/SQL: numeric or value error

-- ===============================
-- FUNCTION: UNORGANIZED.PG1_GET_EMPLOYEE_CV_HTML
-- ===============================

  CREATE OR REPLACE EDITIONABLE FUNCTION "UNORGANIZED"."PG1_GET_EMPLOYEE_CV_HTML" (p_emp_id NUMBER)
RETURN CLOB
IS
    l_html CLOB;
...
-- ===============================
-- FUNCTION: UNORGANIZED.PG1_GET_EMPLOYEE_CV_HTML2
-- ===============================

  CREATE OR REPLACE EDITIONABLE FUNCTION "UNORGANIZED"."PG1_GET_EMPLOYEE_CV_HTML2" (p_emp_id NUMBER)
RETURN CLOB
IS
    l_html CLOB;
    l_emp_rec PG1_EMPLOYEE_MASTER%ROWTYPE;
...
-- ===============================
-- PROCEDURE: UNORGANIZED.PG1_API_GET_DEPARTMENT_LIST
-- ===============================

  CREATE OR REPLACE EDITIONABLE PROCEDURE "UNORGANIZED"."PG1_API_GET_DEPARTMENT_LIST" ( 
...
-- ===============================
-- PROCEDURE: UNORGANIZED.PG1_API_GET_DESIGNATION_LIST
-- ===============================

  CREATE OR REPLACE EDITIONABLE PROCEDURE "UNORGANIZED"."PG1_API_GET_DESIGNATION_LIST" ( 
...
-- ===============================
-- PROCEDURE: UNORGANIZED.PG1_API_GET_EMPLOYEE_FULL_JSON
-- ===============================

  CREATE OR REPLACE EDITIONABLE PROCEDURE "UNORGANIZED"."PG1_API_GET_EMPLOYEE_FULL_JSON" ( 
...
-- ===============================
-- PROCEDURE: UNORGANIZED.PG1_PROC_GET_CV_DATA
-- ===============================

  CREATE OR REPLACE EDITIONABLE PROCEDURE "UNORGANIZED"."PG1_PROC_GET_CV_DATA" AS
    v_emp_id NUMBER;
    v_result CLOB;
BEGIN
...
-- ===============================
-- PROCEDURE: UNORGANIZED.PG1_PROC_GET_EMPLOYEE_LIST
-- ===============================

  CREATE OR REPLACE EDITIONABLE PROCEDURE "UNORGANIZED"."PG1_PROC_GET_EMPLOYEE_LIST" AS
...
-- ===============================
-- PROCEDURE: UNORGANIZED.PG1_PROC_GET_LOOKUP_DATA
-- ===============================

  CREATE OR REPLACE EDITIONABLE PROCEDURE "UNORGANIZED"."PG1_PROC_GET_LOOKUP_DATA" AS
...
-- ===============================
-- PROCEDURE: UNORGANIZED.PG1_PROC_SAVE_EMPLOYEE
-- ===============================

  CREATE OR REPLACE EDITIONABLE PROCEDURE "UNORGANIZED"."PG1_PROC_SAVE_EMPLOYEE" (
...
-- ===============================
-- PROCEDURE: UNORGANIZED.PG1_PROC_VALIDATE_FIELD
-- ===============================

  CREATE OR REPLACE EDITIONABLE PROCEDURE "UNORGANIZED"."PG1_PROC_VALIDATE_FIELD" AS
...
-- ===============================
-- PASS 2: Views and Dependent Objects
-- ===============================

-- ===============================
-- VIEW: UNORGANIZED.PG1_VW_EMPLOYEE_COMPLETE
-- ===============================

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "UNORGANIZED"."PG1_VW_EMPLOYEE_COMPLETE" ("EMP_ID", "EMP_CODE", "FIRST_NAME", "LAST_NAME", "FULL_NAME", "EMAIL", "PHONE", "MOBILE", "NID", "DATE_OF_BIRTH", "GENDER", "BLOOD_GROUP", "RELIGION", "DEPARTMENT_ID", "DEPARTMENT_NAME", "DESIGNATION_ID", "DESIGNATION_NAME", "JOIN_DATE", "SALARY", "ADDRESS_PRESENT", "ADDRESS_PERMANENT", "EMERGENCY_CONTACT_NAME", "EMERGENCY_CONTACT_PHONE", "MARITAL_STATUS", "SKILLS", "PHOTO_FILENAME", "EXPERIENCE_YEARS", "EDUCATION_COUNT", "EXPERIENCE_COUNT", "IS_ACTIVE", "CREATED_DATE", "CREATED_BY", "MODIFIED_DATE", "MODIFIED_BY") AS 
  SELECT 
    e.EMP_ID,
    e.EMP_CODE,
    e.FIRST_NAME,
...
-- ===============================
-- VIEW: UNORGANIZED.PG1_VW_EMPLOYEE_LIST
-- ===============================

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "UNORGANIZED"."PG1_VW_EMPLOYEE_LIST" ("EMP_ID", "EMP_CODE", "FULL_NAME", "EMAIL", "PRIMARY_PHONE", "DEPARTMENT_NAME", "DESIGNATION_NAME", "JOIN_DATE_FORMATTED", "PHOTO_AVAILABLE", "IS_ACTIVE") AS 
  SELECT 
    e.EMP_ID,
    e.EMP_CODE,
    e.FULL_NAME,
...
-- ERROR: Could not get DDL for PACKAGE BODY PG1_PKG_EMPLOYEE_MGMT
-- Error: ORA-31600: invalid input value PACKAGE BODY for parameter OBJECT_TYPE in function GET_DDL

-- ===============================
-- TRIGGER: UNORGANIZED.PG1_TRG_EMPLOYEE_EDUCATION_BI
-- ===============================

  CREATE OR REPLACE EDITIONABLE TRIGGER "UNORGANIZED"."PG1_TRG_EMPLOYEE_EDUCATION_BI" 
...
END;
/
ALTER TRIGGER "UNORGANIZED"."PG1_TRG_EMPLOYEE_EDUCATION_BI" ENABLE;
/

-- ===============================
-- TRIGGER: UNORGANIZED.PG1_TRG_EMPLOYEE_EXPERIENCE_BI
-- ===============================

  CREATE OR REPLACE EDITIONABLE TRIGGER "UNORGANIZED"."PG1_TRG_EMPLOYEE_EXPERIENCE_BI" 
...
END;
/
ALTER TRIGGER "UNORGANIZED"."PG1_TRG_EMPLOYEE_EXPERIENCE_BI" ENABLE;
/

-- ===============================
-- TRIGGER: UNORGANIZED.PG1_TRG_EMPLOYEE_MASTER_BIU
-- ===============================

  CREATE OR REPLACE EDITIONABLE TRIGGER "UNORGANIZED"."PG1_TRG_EMPLOYEE_MASTER_BIU" 
...
END;
/
ALTER TRIGGER "UNORGANIZED"."PG1_TRG_EMPLOYEE_MASTER_BIU" ENABLE;
/

-- ===============================
-- PASS 3: Recompile Invalid Objects
-- ===============================
